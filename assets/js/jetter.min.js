...
(function(){
  ...
  function _mesShow(a, b, c, d, e) {
    ...
    setTimeout(function(){J.id("jetNoteWrapper").css("top", "0");},0);
    c = J.checkArg(c, 1500);
    if (c.constructor == String) {
      switch (c) {
      case "slower":
  ...
  function _setNoteStyle(a) {
    ...
    J.noteStyleStr = a;
    if (J.id("jetNoteWrapper") != undefined) {
      J.id("jetNoteWrapper").attr("jet-style", a)
    }
  };
  function _checkArg(a, b) {
    return (a == undefined) ? b : a
